...
fun main() {
    PostgreSQLContainer("postgres:13.2")
        ...
        transaction(database) {
            ...
            // Tables.updatedAt is database-generated, so provide the database-side value this standalone logger needs.
            exec("ALTER TABLE talks ALTER COLUMN updated_at SET DEFAULT CURRENT_TIMESTAMP")
